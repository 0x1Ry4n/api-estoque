...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleResponseStatusException(ResponseStatusException ex) {
        ApiResponse apiResponse = new ApiResponse(ex.getReason(), false);
        return ResponseEntity.status(ex.getStatusCode()).body(apiResponse);
    }

    @ExceptionHandler(NoHandlerFoundException.class)
    public ResponseEntity<ApiResponse> handleNoHandlerFoundException(NoHandlerFoundException ex) {
        ApiResponse apiResponse = new ApiResponse("Rota não encontrada.", false);
    ...
    public ResponseEntity<ApiResponse> handleException(Exception ex) {
        ...
        ApiResponse apiResponse = new ApiResponse("Erro interno do servidor.", false);
