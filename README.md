...
- **Localização do arquivo:** `imagens/diagrama_classe.png`
...
- **Localização do arquivo:** `imagens/diagrama_caso_de_uso.png`
...
- **Localização do arquivo:** `imagens/diagrama_er.png`
